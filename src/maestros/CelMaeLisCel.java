 ...
 * @author prof_tes_a
 */
public class CelMaeLisCel extends javax.swing.JInternalFrame
{
    private Vector<String> vecMod, vecMar;

    /**
     * Creates new form CelMaeLisCel
     */
    public CelMaeLisCel()
    {
        initComponents();
        vecMod=new Vector<String>();
        vecMar=new Vector<String>();
        lstMod.setListData(vecMod);
    ...
    private void initComponents() {
        ...
        lstMod.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(lstMod);
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(120, 238));
    ...
    private javax.swing.JList lstMod;
    // End of variables declaration//GEN-END:variables

    private boolean abrirListadoCelulares()
    {
        boolean blnRes=true;
        try
        {
...
//                objCarMaeVeh.setVisible(true);
    ...
    private boolean abrirArcXLS(String strNomArc)
    {
        ...
        try
        {
            ...
            jxl.Cell objCel;
            vecMod.removeAllElements();
            vecMar.removeAllElements();
            for (int i=1; i<=8; i++)
            {
                objCel=objShe.getCell(0, i);
                vecMod.add(objCel.getContents());
