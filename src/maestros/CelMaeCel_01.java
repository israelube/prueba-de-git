 ...
 * @author prof_tes_a
 */
public class CelMaeCel_01 extends javax.swing.JDialog
{
    private boolean blnAce;
    private Vector<String> vecMar, vecImgMar;

    /**
     * Creates new form CelMaeCel_01
     */
    public CelMaeCel_01(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(434, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CelMaeCel_01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CelMaeCel_01 dialog = new CelMaeCel_01(new javax.swing.JFrame(), true);
